...
void main() {
  runApp(const ProviderScope(child: USCDoorDrink()));
}


class USCDoorDrink extends StatelessWidget {
  const USCDoorDrink({Key? key}) : super(key: key);
...
//   @override
//   MapBodyWidgetState createState() {
//     return new MapBodyWidgetState();
//   }
// }


// class MapBodyWidgetState extends State<MapBodyWidget> {
...
//       onGenerateRoute: FluoroRouter.router.generator // need to update to
//       // newer router system
//     );
